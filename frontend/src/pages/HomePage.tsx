    ...
    <>
      ...
      <div className="ozellikler" style={{ marginTop: "2.4rem", paddingBottom: "1.6rem" }}>
        ...
        <div className="ozellik">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"><path d="M5 20v-7" /><path d="M12 20V5" /><path d="M19 20v-10" /><path d="M3 20h18" /></svg>
          Fark Yarat
        </div>
      </div>
